package com.mooseengine.core;

/**
 * Acting as MooseEngine's heartbeat, the {@code Chronometer} manages the system's temporal logic.
 * 
...
class Chronometer implements Runnable {
    ...
    private Nexus updateable;

    public Chronometer(Nexus updateable) {
